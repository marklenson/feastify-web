    ...
    return (
        <>
            <section className="container d-flex flex-column align-items-center mb-4 mt-5" style={{height: 'auto'}}>
                ...
                <Link to={eventData} className="btn bg-black text-white px-5 py-3 rounded-pill mt-2 mb-2 fs-5" style={{font: 'Nunito'}}>
            ...
            <section className="container mb-5">
                <p className="fs-1 fw-bold text-center" style={{font: 'Nunito'}}>
