                ...
                <div className="container d-flex flex-column">
                    <div className="row">
                        ...
                        <div className="col-md-3 p-4 text-center text-md-start">
                            ...
                            <p className="fs-6 fw-normal">
                                <a className="text-dark text-decoration-none" href="#faq-section"
                                   style={{font: 'Nunito', fontWeight: 380}}>FAQ</a>
                            </p>
                    ...
                    <div className="d-flex flex-column align-items-center mb-3">
                        <div className="d-flex flex-row mb-3" style={{onHover: 'red'}}>
                            ...
                            <a href="https://www.linkedin.com/company/thefeastify/" target="_blank"
